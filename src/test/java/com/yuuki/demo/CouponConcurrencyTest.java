...
class CouponConcurrencyTest {
    ...
    void testSynchronized_ConcurrencyIssue() throws InterruptedException {
        ...
        // Synchronized는 동시성 제어에 실패하여 100개보다 많이 발급될 수 있음
        log.warn("⚠️ Synchronized는 @Transactional과 함께 사용 시 동시성 제어에 실패할 수 있습니다.");
        log.warn("⚠️ 실제 발급 수량: {}, 예상 수량: 100", finalCoupon.getIssuedQuantity());
    }
